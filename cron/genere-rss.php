<?php 
    ...
    foreach($articles as $article){
        ...
        $entry = ['title'       => $article->title, 'link'        => "http://www.lepetitcharsien.com/{$route}/{$article->basename}", 'description' => substr(strip_tags((string) $article->content),0, 300), 'lastUpdate'  => $date->get(Aurel_Date::TIMESTAMP)];
